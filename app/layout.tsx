...
// Use a valid Google font, e.g., Inter
const inter = Inter({ subsets: ["latin"], display: "swap" });

export const metadata: Metadata = {
  title: "Azizur Rahaman | Full Stack Developer & Creative Technologist",
  description:
    "Portfolio of Azizur Rahaman - Full stack developer specializing in web development, 3D animations, and digital experiences. Founder of Softimize.",
  generator: "v0.app",
}
        ...
        <Script id="dynamic-favicon" strategy="beforeInteractive">
          {`
            function updateFavicon() {
              ...
              const faviconHref = darkMode ? '/icons/favicon-dark.svg' : '/icons/favicon-light.svg';
