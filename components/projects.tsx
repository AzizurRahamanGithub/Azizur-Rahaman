...
export function Projects() {
  ...
  const projects: Project[] = [
    ...
    // Frontend Projects
    {
      ...
      category: "frontend",
      image: "/placeholder.svg",
      link: "https://github.com/AzizurRahamanGithub?tab=repositories",
    ...
    },
    {
      ...
      tags_list: ["React", "DRF", "CSS Grid", "Audio API", "PWA"],
      category: "frontend",
      image: "/placeholder.svg",
      link: "https://github.com/AzizurRahamanGithub/music-streaming-api",
