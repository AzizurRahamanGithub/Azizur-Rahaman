...
import Head from "next/head" // Import for dynamic meta tags
...
export function Hero() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        console.log("backend Error fetching hero data:", error)
        setData({
          title: "Building Scalable Systems That Matter",
          subtitle:
            "Full-stack Software Engineer with a passion for scalable architecture. Turning complex business problems into elegant backend solutions using Python, Next.js, Docker, Redis, Celery, AWS, Digital-ocean, Hostinger.",
  ...
  return (
    <>
      {/* SEO meta tags */}
      <Head>
        <title>{data?.title} | Azizur Rahaman - Software Developer</title>
      ...
      <section className="min-h-screen flex items-center justify-center px-4 md:px-8 py-20 md:py-32 pt-32 md:pt-40">
        <div className="max-w-4xl mx-auto text-center space-y-8">
          ...
          <div className="flex justify-center gap-7 mt-6 pt-8 flex-wrap">
            <a
            ...
            <a
              href="https://codeforces.com/profile/Azizur_Rahaman"
              target="_blank"
              rel="noopener noreferrer"
              className="text-gray-400 hover:text-blue-500 transition-colors"
            >
            ...
            <a
              href="https://www.facebook.com/share/17Td2ju3hp/"
              target="_blank"
              rel="noopener noreferrer"
              className="text-gray-400 hover:text-blue-500 transition-colors"
            >
