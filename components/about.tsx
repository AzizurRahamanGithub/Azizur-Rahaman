  ...
  useEffect(() => {
    const fetchAbout = async () => {
      try {
        ...
        console.log("BackEnd Error fetching about data, using fallback:", error)
        setAbout({
          id: 1,
          title: "About Me",
          profile_photo: "/azizur rahaman softwear developer azizur.dev.png",
          bio_paragraphs:
            "Hi, I'm Azizur Rahaman, a Software Engineer with 2+ years of experience building scalable, production-ready web applications. I specialize in backend development with Django REST Framework and FastAPI, paired with modern frontends using Next.js and React. I enjoy solving complex business problems from designing permission-driven APIs to deploying secure systems on AWS and Docker. I'm passionate about writing clean, maintainable code and continuously improving my craft.",
          achievements:
            "2+ years of professional software engineering experience\nICPC Dhaka Regional participant — Rank 144 of +400 teams (2025)\nICPC Dhaka Regional participant — Rank 199 of +350 teams (2024)\n600+ problems solved on Codeforces, LeetCode, and HackerRank\nExperienced in Django REST Framework, FastAPI, Next.js, and PostgreSQL\nHands-on with Docker, Celery, PM2, Digitalocean and AWS (EC2, S3, RDS, IAM), and production deployments",
        })
      } finally {
        setLoading(false)
      }
            ...
            <div className="space-y-6">
              ...
              <div className="flex sm:flex-col gap-5 *:text-center">
                <Link
                  ...
                  href="https://drive.google.com/file/d/1Y8_LvTaEooVc1w69k9g4FclrqtRpENw3/view?usp=sharing"
                  target="_blank"
                  passHref
                >
                ...
                <Link download="Full Stack App & Web Developer Azizur Rahaman.pdf"
                  className="inline-block px-6 py-2 rounded-lg bg-blue-500/20 border border-blue-400/50 text-blue-300 hover:bg-blue-500/30 transition text-nowrap"
                  href="/files/Azizur_Rahaman_+2_Software_Enginner.pdf"
                  passHref
                >
                  Download Resume
                </Link>
