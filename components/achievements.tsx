  ...
  useEffect(() => {
    const fetchAchievements = async () => {
      try {
        ...
        console.log("BackEnd Error fetching achievements, using fallback data:", error)
        const achievementsData: Achievement[] = [
          ...
          {
            id: 2,
            title: "ICPC 2025 - International Collegiate Programming Contest",
            description:
              "Competed in the ICPC Dhaka Regional 2025 as a member of Team Scholars_Byte_Brigade from the University of Scholars. Solved 2 hard problems and ranked 144 out of  top 300+ teams around Bangladesh.",
            issuer: "International Collegiate Programming Contest",
            date: "2025-11-15",
            achievement_type: "competition",
          },
